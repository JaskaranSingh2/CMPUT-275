...
// This function here shouldn't be part of our ADT,
// it's included just to demonstrate the issue in main3
void printListByVal(struct List l) {
  printf("Got this list by value, it's length is %d\n", l.len);
}
